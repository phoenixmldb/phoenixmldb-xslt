...
internal sealed class XsltAccumulatorBeforeFunction : PhoenixmlDb.XQuery.Ast.XQueryFunction
{
    ...
    {
        var name = arguments[0]?.ToString() ?? throw new XsltException("XTDE3340: accumulator-before() requires a name argument");
