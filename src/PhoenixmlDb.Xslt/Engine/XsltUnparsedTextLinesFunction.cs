...
/// <summary>
/// XSLT unparsed-text-lines($href) function — reads a text file and splits into lines.
/// </summary>
internal sealed class XsltUnparsedTextLinesFunction : PhoenixmlDb.XQuery.Ast.XQueryFunction
{
    private readonly DefaultXsltExecutionContext _context;
    public XsltUnparsedTextLinesFunction(DefaultXsltExecutionContext context) => _context = context;
