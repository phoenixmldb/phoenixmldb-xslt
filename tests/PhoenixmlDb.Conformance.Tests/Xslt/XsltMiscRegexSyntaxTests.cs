...
/// <summary>
/// W3C XSLT 3.0 conformance tests for regex-syntax (993 test cases).
/// Split from XsltMiscTests to avoid resource/timeout issues.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "misc")]
public class XsltMiscRegexSyntaxTests : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltMiscRegexSyntaxTests(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/misc/regex-syntax/_regex-syntax-test-set.xml")]
