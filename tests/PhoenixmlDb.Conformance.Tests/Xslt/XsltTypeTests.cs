...
/// <summary>
/// W3C XSLT 3.0 conformance tests for type-related features (type/*).
/// Covers arrays, booleans, dates, maps, namespaces, nodes, strings, and type checking.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "type")]
public class XsltTypeTests : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltTypeTests(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/type/arrays/_arrays-test-set.xml")]
    [InlineData("tests/type/boolean/_boolean-test-set.xml")]
    [InlineData("tests/type/date/_date-test-set.xml")]
    [InlineData("tests/type/maps/_maps-test-set.xml")]
    [InlineData("tests/type/namespace/_namespace-test-set.xml")]
    [InlineData("tests/type/node/_node-test-set.xml")]
    [InlineData("tests/type/notation/_notation-test-set.xml")]
    [InlineData("tests/type/string/_string-test-set.xml")]
    [InlineData("tests/type/type/_type-test-set.xml")]
