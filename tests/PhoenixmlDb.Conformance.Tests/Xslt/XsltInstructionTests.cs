...
/// <summary>
/// W3C XSLT 3.0 conformance tests for instruction features (insn/*).
/// Covers choose, copy, element, iterate, for-each-group, apply-templates, and more.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "insn")]
public class XsltInstructionTests : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltInstructionTests(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/insn/element/_element-test-set.xml")]
    [InlineData("tests/insn/evaluate/_evaluate-test-set.xml")]
    [InlineData("tests/insn/for-each-group/_for-each-group-test-set.xml")]
    [InlineData("tests/insn/lre/_lre-test-set.xml")]
    [InlineData("tests/insn/merge/_merge-test-set.xml")]
    [InlineData("tests/insn/number/_number-test-set.xml")]
    [InlineData("tests/insn/result-document/_result-document-test-set.xml")]
    [InlineData("tests/insn/sequence/_sequence-test-set.xml")]
    [InlineData("tests/insn/try/_try-test-set.xml")]
