...
/// <summary>
/// W3C XSLT 3.0 conformance tests for expression features (expr/*).
/// Covers axes, paths, predicates, casting, type expressions, math, and XPath compatibility.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "expr")]
public class XsltExpressionTests : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltExpressionTests(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/expr/axes/_axes-test-set.xml")]
    [InlineData("tests/expr/castable/_castable-test-set.xml")]
    [InlineData("tests/expr/data-manipulation/_data-manipulation-test-set.xml")]
    [InlineData("tests/expr/expression/_expression-test-set.xml")]
    [InlineData("tests/expr/for/_for-test-set.xml")]
    [InlineData("tests/expr/higher-order-functions/_higher-order-functions-test-set.xml")]
    [InlineData("tests/expr/math/_math-test-set.xml")]
    [InlineData("tests/expr/nodetest/_nodetest-test-set.xml")]
    [InlineData("tests/expr/path/_path-test-set.xml")]
    [InlineData("tests/expr/predicate/_predicate-test-set.xml")]
    [InlineData("tests/expr/treat-as/_treat-as-test-set.xml")]
    [InlineData("tests/expr/type-expr/_type-expr-test-set.xml")]
    [InlineData("tests/expr/type-functions/_type-functions-test-set.xml")]
    [InlineData("tests/expr/xpath-compat/_xpath-compat-test-set.xml")]
