...
/// <summary>
/// W3C XSLT 3.0 conformance tests for instruction features (insn/*), part 4.
/// Split to avoid test process memory exhaustion.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "insn")]
public class XsltInstructionTests4 : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltInstructionTests4(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/insn/sort/_sort-test-set.xml")]
