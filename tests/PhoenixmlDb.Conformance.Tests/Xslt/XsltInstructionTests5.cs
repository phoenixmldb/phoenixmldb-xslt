...
/// <summary>
/// W3C XSLT 3.0 conformance tests for instruction features (insn/*), part 5.
/// Split to avoid test process memory exhaustion.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "insn")]
public class XsltInstructionTests5 : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltInstructionTests5(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/insn/xsl-document/_xsl-document-test-set.xml")]
