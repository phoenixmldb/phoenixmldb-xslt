...
/// <summary>
/// W3C XSLT 3.0 conformance tests for instruction features (insn/*), part 3.
/// Split to avoid test process memory exhaustion.
/// </summary>
[Trait("Category", "Conformance")]
[Trait("Suite", "XSLT")]
[Trait("Group", "insn")]
public class XsltInstructionTests3 : IClassFixture<XsltTestFixture>
{
    private readonly XsltTestFixture _fixture;
    private readonly ITestOutputHelper _output;

    public XsltInstructionTests3(XsltTestFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Theory]
    [InlineData("tests/insn/copy/_copy-test-set.xml")]
    [InlineData("tests/insn/iterate/_iterate-test-set.xml")]
    [InlineData("tests/insn/message/_message-test-set.xml")]
    [InlineData("tests/insn/next-match/_next-match-test-set.xml")]
    [InlineData("tests/insn/on-empty/_on-empty-test-set.xml")]
    [InlineData("tests/insn/on-non-empty/_on-non-empty-test-set.xml")]
    [InlineData("tests/insn/source-document/_source-document-test-set.xml")]
    [InlineData("tests/insn/where-populated/_where-populated-test-set.xml")]
